...
r301 %r{/(.*)/gemfire-native-client/(.*)}, "http://gemfire-native.docs.pivotal.io/$1/gemfire/$2"
r301 %r{/(.*)/geode-native-client/(.*)}, "http://gemfire-native.docs.pivotal.io/$1/geode/$2"
r301 %r{/(.*)/gemfire-native-client-ssp/(.*)}, "http://gemfire-native.docs.pivotal.io/$1/gemfire/$2"
r301 %r{/(.*)/gemfire-native/(.*)}, "http://gemfire-native.docs.pivotal.io/$1/gemfire/$2"
r301 %r{/(.*)/geode-native/(.*)}, "http://gemfire-native.docs.pivotal.io/$1/geode/$2"
r301 %r{/(.*)/gemfire-native-ssp/(.*)}, "http://gemfire-native.docs.pivotal.io/$1/gemfire/$2"
...
r301 %r{/pre-release/(.*)}, 'https://docs-pcf-staging.cfapps.io/pivotalcf/2-5/installing/pcf-docs.html'
...
r301 %r{/windows/(.*)}, 'http://docs.pivotal.io/pivotalcf/2-5/windows/index.html'
...
r301 %r{/pivotalcf/(?![\d-]+)(.*)}, "/pivotalcf/2-5/$1"
...
r301 '/pivotalcf/2-5/getstarted/pcf-docs.html', '/pivotalcf/2-5/'

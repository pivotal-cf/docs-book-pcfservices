...
r301 %r{/11-3/(.*)}, "https://postgres.docs.pivotal.io/11-3/$1"
r301 %r{/13-4/(.*)}, "https://postgres.docs.pivotal.io/13-4/$1"
r301 %r{/12-8/(.*)}, "https://postgres.docs.pivotal.io/12-8/$1"
r301 %r{/12-7/(.*)}, "https://postgres.docs.pivotal.io/12-7/$1"
r301 %r{/12-6/(.*)}, "https://postgres.docs.pivotal.io/12-6/$1"
r301 %r{/12-5/(.*)}, "https://postgres.docs.pivotal.io/12-5/$1"
r301 %r{/12-4/(.*)}, "https://postgres.docs.pivotal.io/12-4/$1"
r301 %r{/12-3/(.*)}, "https://postgres.docs.pivotal.io/12-3/$1"
r301 %r{/11-13/(.*)}, "https://postgres.docs.pivotal.io/11-13/$1"
r301 %r{/11-12/(.*)}, "https://postgres.docs.pivotal.io/11-12/$1"
r301 %r{/11-11/(.*)}, "https://postgres.docs.pivotal.io/11-11/$1"
r301 %r{/11-10/(.*)}, "https://postgres.docs.pivotal.io/11-10/$1"
r301 %r{/11-9/(.*)}, "https://postgres.docs.pivotal.io/11-9/$1"
r301 %r{/11-7/(.*)}, "https://postgres.docs.pivotal.io/11-7/$1"
r301 %r{/11-6/(.*)}, "https://postgres.docs.pivotal.io/11-6/$1"
r301 %r{/11-5/(.*)}, "https://postgres.docs.pivotal.io/11-5/$1"
r301 %r{/11-4/(.*)}, "https://postgres.docs.pivotal.io/11-4/$1"
r301 %r{/11-3/(.*)}, "https://postgres.docs.pivotal.io/11-3/$1"
r301 %r{/11-2/(.*)}, "https://postgres.docs.pivotal.io/11-2/$1"
r301 %r{/11-1/(.*)}, "https://postgres.docs.pivotal.io/11-1/$1"
r301 %r{/10-18/(.*)}, "https://postgres.docs.pivotal.io/10-18/$1"
r301 %r{/10-17/(.*)}, "https://postgres.docs.pivotal.io/10-17/$1"
r301 %r{/10-16/(.*)}, "https://postgres.docs.pivotal.io/10-16/$1"
r301 %r{/10-15/(.*)}, "https://postgres.docs.pivotal.io/10-15/$1"
r301 %r{/10-14/(.*)}, "https://postgres.docs.pivotal.io/10-14/$1"
...
r301 %r{/tkgi/1-12/(.*)}, "https://docs.vmware.com/en/VMware-Tanzu-Kubernetes-Grid-Integrated-Edition/1.12/tkgi/GUID-$1"
...
# Redirect all TAS for Kubernetes to v0.7
r301 %r{/tas-kubernetes/(?![\d-]+)(.*)}, '/tas-kubernetes/0-7/$1'
r301 %r{/pas-kubernetes/(?![\d-]+)(.*)}, '/tas-kubernetes/0-7/$1'
...
r302 %r{/addon-antivirus/(?![\d-]+)(.*)}, "https://docs.vmware.com/en/Anti-Virus-for-VMware-Tanzu/index.html"
...
r302 %r{/rabbitmq-cf/(?![\d-]|[p][a][r][t]+)(.*)}, "/rabbitmq-cf/2-1/$1"
...
# Redirect old MySQL versions to VMware Docs landing page for MySQL
r301 %r{/p-mysql/2-2/(.*)}, 'https://docs.vmware.com/en/VMware-SQL-with-MySQL-for-Tanzu-Application-Service/index.html'
r301 %r{/p-mysql/2-1/(.*)}, 'https://docs.vmware.com/en/VMware-SQL-with-MySQL-for-Tanzu-Application-Service/index.html'
r301 %r{/p-mysql/2-0/(.*)}, 'https://docs.vmware.com/en/VMware-SQL-with-MySQL-for-Tanzu-Application-Service/index.html'
r301 %r{/p-mysql/1-9/(.*)}, 'https://docs.vmware.com/en/VMware-SQL-with-MySQL-for-Tanzu-Application-Service/index.html'
r301 %r{/p-mysql/1-8/(.*)}, 'https://docs.vmware.com/en/VMware-SQL-with-MySQL-for-Tanzu-Application-Service/index.html'
r301 %r{/p-mysql/1-7/(.*)}, 'https://docs.vmware.com/en/VMware-SQL-with-MySQL-for-Tanzu-Application-Service/index.html'
r301 %r{/p-mysql/1-6/(.*)}, 'https://docs.vmware.com/en/VMware-SQL-with-MySQL-for-Tanzu-Application-Service/index.html'
r301 %r{/p-mysql/1-5/(.*)}, 'https://docs.vmware.com/en/VMware-SQL-with-MySQL-for-Tanzu-Application-Service/index.html'
r301 %r{/p-mysql/1-4/(.*)}, 'https://docs.vmware.com/en/VMware-SQL-with-MySQL-for-Tanzu-Application-Service/index.html'

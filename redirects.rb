...
# 2-7 and later redirects
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/configure-pas.html}, '/application-service/$1/operating/configure-pas.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/console-login.html}, '/application-service/$1/operating/console-login.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/create-pas-dbs.html}, '/application-service/$1/operating/create-pas-dbs.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/creating-account.html}, '/application-service/$1/operating/creating-account.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/custom-load-balancer.html}, '/application-service/$1/operating/custom-load-balancer.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/custom-syslog-rules.html}, '/application-service/$1/operating/custom-syslog-rules.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/day2.html}, '/application-service/$1/operating/day2.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/pas-file-storage.html}, '/application-service/$1/operating/pas-file-storage.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/pas-vsphere-requirements.html}, '/application-service/$1/operating/pas-vsphere-requirements.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/pas.html}, '/application-service/$1/operating/pas.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/diagnostics.html}, '/application-service/$1/operating/diagnostics.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/disk-format.html}, '/application-service/$1/operating/disk-format.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/elb-ssh-proxy.html}, 'application-service/$1/operating/elb-ssh-proxy.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/external-user-management.html}, '/application-service/$1/operating/external-user-management.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/f5-lb.html}, '/application-service/$1/operating/f5-lb.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/frontend-idle-timeout.html}, '/application-service/$1/operating/frontend-idle-timeout.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/quickstart-pas.html}, '/application-service/$1/operating/quickstart-pas.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/route-service-lookup.html}, '/application-service/$1/operating/route-service-lookup.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/api-endpoint.html}, '/application-service/$1/operating/api-endpoint.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/gcp-troubleshooting.html}, '/application-service/$1/operating/gcp-troubleshooting.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/small-footprint.html}, '/application-service/$1/operating/small-footprint.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/installing-pcf-is.html}, '/application-service/$1/operating/installing-pcf-is.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/cfpush-availability-during-upgrade.html}, '/application-service/$1/operating/cfpush-availability-during-upgrade.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/user-types.html}, '/application-service/$1/operating/user-types.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/vsphere-nsx-t.html}, '/application-service/$1/operating/vsphere-nsx-t.html'
r301 %r{/platform/(2-[7-9]|2-\d\d+)/customizing/configure-lb.html}, '/application-service/$1/operating/configure-lb.html'

...
r301 %r{(\/pivotalcf|\/platform)/(2-[7-9]|2-\d\d+)/customizing/custom-load-balancer.html}, '/application-service/$1/operating/custom-load-balancer.html'
r301 %r{(\/pivotalcf|\/platform)/(2-[7-9]|2-\d\d+)/customizing/custom-syslog-rules.html}, '/application-service/$1/operating/custom-syslog-rules.html'
r301 %r{(\/pivotalcf|\/platform)/(2-[7-9]|2-\d\d+)/customizing/day2.html}, '/application-service/$1/operating/day2.html'
r301 %r{(\/pivotalcf|\/platform)/(2-[7-9]|2-\d\d+)/customizing/pas-file-storage.html}, '/application-service/$1/operating/pas-file-storage.html'
r301 %r{(\/pivotalcf|\/platform)/(2-[7-9]|2-\d\d+)/customizing/pas-vsphere-requirements.html}, '/application-service/$1/operating/pas-vsphere-requirements.html'
r301 %r{(\/pivotalcf|\/platform)/(2-[7-9]|2-\d\d+)/customizing/pas.html}, '/application-service/$1/operating/pas.html'

...
r301 %r{/pivotalcf/2-10/windows/(.*)}, "/application-service-windows/2-10/$1"
r301 %r{/pivotalcf/2-11/windows/(.*)}, "/application-service-windows/2-11/$1"
r301 %r{/application-service-windows/2-6/(.*)}, "/pivotalcf/2-6/windows/$1"
...
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/custom-load-balancer.html}, '/application-service/$1/operating/custom-load-balancer.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/custom-syslog-rules.html}, '/application-service/$1/operating/custom-syslog-rules.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/day2.html}, '/application-service/$1/operating/day2.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/pas-file-storage.html}, '/application-service/$1/operating/pas-file-storage.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/pas-vsphere-requirements.html}, '/application-service/$1/operating/pas-vsphere-requirements.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/pas.html}, '/application-service/$1/operating/pas.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/diagnostics.html}, '/application-service/$1/operating/diagnostics.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/disk-format.html}, '/application-service/$1/operating/disk-format.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/elb-ssh-proxy.html}, 'application-service/$1/operating/elb-ssh-proxy.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/external-user-management.html}, '/application-service/$1/operating/external-user-management.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/f5-lb.html}, '/application-service/$1/operating/f5-lb.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/frontend-idle-timeout.html}, '/application-service/$1/operating/frontend-idle-timeout.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/quickstart-pas.html}, '/application-service/$1/operating/quickstart-pas.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/route-service-lookup.html}, '/application-service/$1/operating/route-service-lookup.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/api-endpoint.html}, '/application-service/$1/operating/api-endpoint.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/gcp-troubleshooting.html}, '/application-service/$1/operating/gcp-troubleshooting.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/small-footprint.html}, '/application-service/$1/operating/small-footprint.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/installing-pcf-is.html}, '/application-service/$1/operating/installing-pcf-is.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/cfpush-availability-during-upgrade.html}, '/application-service/$1/operating/cfpush-availability-during-upgrade.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/user-types.html}, '/application-service/$1/operating/user-types.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/vsphere-nsx-t.html}, '/application-service/$1/operating/vsphere-nsx-t.html'
r301 %r{/pivotalcf/(2-[7-9]|2-\d\d+)/customizing/configure-lb.html}, '/application-service/$1/operating/configure-lb.html'

# Ops Guide

# 2-3 to 2-6 redirects
 r301 '/application-service/(2-[3-6])/operating/gdpr.html', '/pivotalcf/$1/opsguide/gdpr.html'
 r301 '/application-service/(2-[3-6])/operating/id-jobs.html', '/pivotalcf/$1/opsguide/id-jobs.html'
 r301 '/application-service/(2-[3-6])/operating/identify-metric-source.html', '/pivotalcf/$1/opsguide/identify-metric-source.html'
 r301 '/application-service/(2-[3-6])/operating/accounting-report-apps-man.html', '/pivotalcf/$1/opsguide/accounting-report-apps-man.html'
 r301 '/application-service/(2-[3-6])/operating/accounting-report.html', '/pivotalcf/$1/opsguide/accounting-report.html'
 r301 '/application-service/(2-[3-6])/operating/internal-databases.html', '/pivotalcf/$1/opsguide/internal-databases.html'
 r301 '/application-service/(2-[3-6])/operating/api-endpoint.html', '/pivotalcf/$1/opsguide/api-endpoint.html'
 r301 '/application-service/(2-[3-6])/operating/logging-config-opsman.html', '/pivotalcf/$1/opsguide/logging-config-opsman.html'
 r301 '/application-service/(2-[3-6])/operating/app-sec-groups.html', '/pivotalcf/$1/opsguide/app-sec-groups.html'
 r301 '/application-service/(2-[3-6])/operating/notifications-asg.html', '/pivotalcf/$1/opsguide/notifications-asg.html'
 r301 '/application-service/(2-[3-6])/operating/auth-sso.html', '/pivotalcf/$1/opsguide/auth-sso.html'
 r301 '/application-service/(2-[3-6])/operating/ca-sso-config.html', '/pivotalcf/$1/opsguide/ca-sso-config.html'
 r301 '/application-service/(2-[3-6])/operating/ping-federate-sso-configuration.html', '/pivotalcf/$1/opsguide/ping-federate-sso-configuration.html'
 r301 '/application-service/(2-[3-6])/operating/config-cell-cleanup.html', '/pivotalcf/$1/opsguide/config-cell-cleanup.html'
 r301 '/application-service/(2-[3-6])/operating/power-failure.html', '/pivotalcf/$1/opsguide/power-failure.html'
 r301 '/application-service/(2-[3-6])/operating/config-proxy.html', '/pivotalcf/$1/opsguide/config-proxy.html'
 r301 '/application-service/(2-[3-6])/operating/pw-policy.html', '/pivotalcf/$1/opsguide/pw-policy.html'
 r301 '/application-service/(2-[3-6])/operating/pws_upgrade_load.html', '/pivotalcf/$1/opsguide/pws_upgrade_load.html'
 r301 '/application-service/(2-[3-6])/operating/config-ssh.html', '/pivotalcf/$1/opsguide/config-ssh.html'
 r301 '/application-service/(2-[3-6])/operating/rotate-ccdb-key.html', '/pivotalcf/$1/opsguide/rotate-ccdb-key.html'
 r301 '/application-service/(2-[3-6])/operating/configure-multi-foundation.html', '/pivotalcf/$1/opsguide/configure-multi-foundation.html'
 r301 '/application-service/(2-[3-6])/operating/scaling-cloud-controller.html', '/pivotalcf/$1/opsguide/scaling-cloud-controller.html'
 r301 '/application-service/(2-[3-6])/operating/creating-account.html', '/pivotalcf/$1/opsguide/creating-account.html'
 r301 '/application-service/(2-[3-6])/operating/scaling-ert-components.html', '/pivotalcf/$1/opsguide/scaling-ert-components.html'
 r301 '/application-service/(2-[3-6])/operating/credential-rotation.html', '/pivotalcf/$1/opsguide/credential-rotation.html'
 r301 '/application-service/(2-[3-6])/operating/secure-si-creds.html', '/pivotalcf/$1/opsguide/secure-si-creds.html'
 r301 '/application-service/(2-[3-6])/operating/custom-branding.html', '/pivotalcf/$1/opsguide/custom-branding.html'
 r301 '/application-service/(2-[3-6])/operating/securing-endpoints.html', '/pivotalcf/$1/opsguide/securing-endpoints.html'
 r301 '/application-service/(2-[3-6])/operating/deploying-service-mesh.html', '/pivotalcf/$1/opsguide/deploying-service-mesh.html'
 r301 '/application-service/(2-[3-6])/operating/security_config.html', '/pivotalcf/$1/opsguide/security_config.html'
 r301 '/application-service/(2-[3-6])/operating/docker-registry.html', '/pivotalcf/$1/opsguide/docker-registry.html'
 r301 '/application-service/(2-[3-6])/operating/ssl-term-haproxy.html', '/pivotalcf/$1/opsguide/ssl-term-haproxy.html'
 r301 '/application-service/(2-[3-6])/operating/enable-vol-services.html', '/pivotalcf/$1/opsguide/enable-vol-services.html'
 r301 '/application-service/(2-[3-6])/operating/ssl-term.html', '/pivotalcf/$1/opsguide/ssl-term.html'
 r301 '/application-service/(2-[3-6])/operating/er_network.html', '/pivotalcf/$1/opsguide/er_network.html'
 r301 '/application-service/(2-[3-6])/operating/switching-domains.html', '/pivotalcf/$1/opsguide/switching-domains.html'
 r301 '/application-service/(2-[3-6])/operating/external-user-management.html', '/pivotalcf/$1/opsguide/external-user-management.html'
 r301 '/application-service/(2-[3-6])/operating/tcp-routing-ert-config.html', '/pivotalcf/$1/opsguide/tcp-routing-ert-config.html'
...
r301 %r{/platform/2-9/security/(.*)}, '/ops-manager/2-9/security/$1'
...
r301 %r{/platform/2-11/upgrading/understanding-pas.html}, '/application-service/2-11/operating/understanding-pas.html'
r301 %r{/platform/2-10/upgrading/understanding-pas.html}, '/application-service/2-10/operating/understanding-pas.html'
r301 %r{/platform/2-9/upgrading/understanding-pas.html}, '/application-service/2-9/operating/understanding-pas.html'
r301 %r{/platform/2-8/upgrading/understanding-pas.html}, '/application-service/2-8/operating/understanding-pas.html'
r301 %r{/platform/2-7/upgrading/understanding-pas.html}, '/application-service/2-7/operating/understanding-pas.html'
r301 %r{/platform/2-11/upgrading/configuring.html}, '/application-service/2-11/operating/configuring.html'
r301 %r{/platform/2-10/upgrading/configuring.html}, '/application-service/2-10/operating/configuring.html'
r301 %r{/platform/2-9/upgrading/configuring.html}, '/application-service/2-9/operating/configuring.html'
r301 %r{/platform/2-8/upgrading/configuring.html}, '/application-service/2-8/operating/configuring.html'
r301 %r{/platform/2-7/upgrading/configuring.html}, '/application-service/2-7/operating/configuring.html'
r301 %r{/platform/2-10/upgrading/checklist.html}, '/ops-manager/2-10/upgrade/checklist.html'
r301 %r{/platform/2-9/upgrading/checklist.html}, '/ops-manager/2-9/upgrade/checklist.html'
r301 %r{/platform/2-8/upgrading/checklist.html}, '/ops-manager/2-8/upgrade/checklist.html'
r301 %r{/platform/2-7/upgrading/checklist.html}, '/ops-manager/2-7/upgrade/checklist.html'
...
r301 %r{/platform/ops-manager/2-6/(.*)}, "/ops-manager/2-6/$1"
r301 %r{/platform/ops-manager/2-5/(.*)}, "/ops-manager/2-5/$1"
r301 %r{/platform/ops-manager/2-4/(.*)}, "/ops-manager/2-4/$1"
r301 %r{/platform/ops-manager/2-3/(.*)}, "/ops-manager/2-3/$1"
r301 %r{/platform/ops-manager/2-2/(.*)}, "/ops-manager/2-2/$1"
r301 %r{/platform/ops-manager/2-1/(.*)}, "/ops-manager/2-1/$1"
r301 %r{/platform/ops-manager/2-0/(.*)}, "/ops-manager/2-0/$1"
...
r301 %r{/pivotalcf/2-3/operating/(.*)}, '/application-service/2-3/operating/$1'
r301 %r{/pivotalcf/2-2/operating/(.*)}, '/application-service/2-2/operating/$1'
r301 %r{/pivotalcf/2-1/operating/(.*)}, '/application-service/2-1/operating/$1'
r301 %r{/pivotalcf/2-0/operating/(.*)}, '/application-service/2-0/operating/$1'
...
r301 %r{/p-mysql/1-6/(.*)}, 'http://docs.pivotal.io/archives/mysql-docs-1.7.pdf'
r301 %r{/p-mysql/1-5/(.*)}, 'http://docs.pivotal.io/archives/mysql-docs-1.7.pdf'
r301 %r{/p-mysql/1-4/(.*)}, 'http://docs.pivotal.io/archives/mysql-docs-1.7.pdf'

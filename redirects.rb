...
r302 %r{/service-backup/(?![\d-]+)(.*)}, "/service-backup/18-0/$1"
r302 %r{/buildpacks/(.*)}, '/pivotalcf/1-9/buildpacks/$1'
r302 %r{/deploying/(.*)}, '/pivotalcf/1-9/deploying/$1'
r302 %r{/concepts/(.*)}, '/pivotalcf/1-9/concepts/$1'
r302 %r{/adminguide/(.*)}, '/pivotalcf/1-9/adminguide/$1'
r302 %r{/cf-cli/(.*)}, '/pivotalcf/1-9/cf-cli/$1'
r302 %r{/devguide/(.*)}, '/pivotalcf/1-9/devguide/$1'
r302 %r{/loggregator/(.*)}, '/pivotalcf/1-9/loggregator/$1'
r302 %r{/services/(.*)}, '/pivotalcf/1-9/services/$1'
r302 %r{/opsguide/(.*)}, '/pivotalcf/1-9/opsguide/$1'
r302 %r{/installing/(.*)}, '/pivotalcf/1-9/installing/$1'
r302 %r{/customizing/(.*)}, '/pivotalcf/1-9/customizing/$1'
r302 %r{/appsman-services/(.*)}, '/pivotalcf/1-9/appsman-services/$1'
...
r302 %r{/rabbitmq-cf/1-5-[\d]+/(.*)}, "/rabbitmq-cf/1-5/$1"

r302 %r{/bosh/(.*)}, 'http://bosh.io/docs/$1'
r302 %r{/jmx-bridge/(?![\d-]+)(.*)}, "/jmx-bridge/1-9/$1"
r302 %r{/p-mysql/(?![\d-]+)(.*)}, "/p-mysql/1-9/$1"
...
r302 %r{/pre-release/(.*)}, 'https://docs-pcf-staging.cfapps.io/pivotalcf/1-9/installing/pcf-docs.html'
...
r302 '/jmx-bridge/', '/jmx-bridge/1-9/index.html'
...
r302 %r{/windows/(.*)}, 'http://docs.pivotal.io/pivotalcf/1-9/windows/index.html'
# Link structure changed for ODB, service-backup and service-metrics
r302 %r{/on-demand-service-broker/(\d+)-(\d+)-\d+/(.*)}, "/on-demand-service-broker/$1-$2/$3"
r302 %r{/service-metrics/(\d+)-(\d+)-\d+/(.*)}, "/service-metrics/$1-$2/$3"
r302 %r{/service-backup/(\d+)-(\d+)-\d+/(.*)}, "/service-backup/$1-$2/$3"

...
r301 '/p-identity/1-5/plan-to-plan/config-plan-to-plan-oidc.html', '/p-identity/1-5/configure-plan-to-plan-oidc.html'
r301 '/p-identity/1-5/plan-to-plan/testing.html', '/p-identity/1-5/oidc-testing.html'
r301 '/p-identity/1-5/plan-to-plan/troubleshooting.html', '/p-identity/1-5/oidc-troubleshooting.html'

r301 '/p-identity/1-6/plan-to-plan-oidc.html', '/p-identity/1-6/plan-to-plan/index.html'
r301 '/p-identity/1-6/configure-plan-to-plan-oidc.html', '/p-identity/1-6/plan-to-plan/config-plan-to-plan-oidc.html'
r301 '/p-identity/1-6/oidc-testing.html', '/p-identity/1-6/plan-to-plan/testing.html'
r301 '/p-identity/1-6/oidc-troubleshooting.html', '/p-identity/1-6/plan-to-plan/troubleshooting.html'
...
r301 %r{/p-identity/([\d-]+)/configure-apps/index.html}, '/p-identity/$1/config-apps.html'

# Redirects from removed SSO topics.
r301 '/p-identity/1-10/azure-oidc/config-sso.html', '/p-identity/1-10/azure-oidc/config-azure.html#config-sso'

r301 %r{/p-identity/([\d-]+)/configure-apps/web-service-to-service-app.html}, '/p-identity/$1/determine-type.html'
r301 %r{/p-identity/([\d-]+)/configure-apps/web-app.html}, '/p-identity/$1/determine-type.html'
r301 %r{/p-identity/([\d-]+)/configure-apps/single-page-js-app.html}, '/p-identity/$1/determine-type.html'
r301 %r{/p-identity/([\d-]+)/configure-apps/service-to-service-app.html}, '/p-identity/$1/determine-type.html'
r301 %r{/p-identity/([\d-]+)/configure-apps/native-app.html}, '/p-identity/$1/determine-type.html'
